  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/products/:slug" element={<PageContainer><ProductDetails /></PageContainer>} />
        <Route path="/brands" element={<PageContainer><Brands /></PageContainer>} />
        <Route path="/projects" element={<PageContainer><Projects /></PageContainer>} />
        <Route path="/quote" element={<PageContainer><Quote /></PageContainer>} />
